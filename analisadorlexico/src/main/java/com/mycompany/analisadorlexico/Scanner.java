...
public class Scanner{
    ...
    private void take (char expectedChar){
     ...
     switch(currentChar){
      ...
      case ',' : takeIt(); System.out.println("Atual tipo: "+Token.VIRG);System.out.println("Atual Conteudo: "+currentSpelling); System.out.println("Coluna: "+colunas+", Linhas: "+linhas+'\n');return Token.VIRG;
